    ...
    <div class="template_header">
        ...
        <div class="template_person">
            ...
            <div class="template_person_name_title">
                <h2 class="template_person_name template_text_dark" id="template_person_name">
                    Youssef Ahmed
                </h2>
                <p class="template_person_title template_text_dark" id="template_person_title">
                    Web Developer
                </p>
            </div>
        </div>
    ...
    <div class="template-body">
        ...
        <div class="template_right_area">
            ...
            <div class="template_sm_section">
                ...
                <p class="template_sm_section_text" id="template_person_email">
                    youssef@gmail.com
                </p>
            </div>
            ...
            <div class="template_sm_section">
                ...
                <p class="template_sm_section_text" id="template_person_phone">
                    01154214028
                </p>
            </div>
            <!-- End Template Small Section -->
